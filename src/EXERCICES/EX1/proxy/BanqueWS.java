 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://EX1.EXERCICES/", wsdlLocation = "http://localhost:8088/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://EX1.EXERCICES/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://EX1.EXERCICES/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://EX1.EXERCICES/", "BanqueServicePort"), BanqueService.class, features);
    }
